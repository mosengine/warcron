<?
// version 1.0 december 2005 Unix version for multiple databases
// for win32 replace with backup_timeout.php if you get errors
// multiple databases
include "dbinfo.php";
  ...
  <TABLE WIDTH="80%" border="0" cellspacing="0" bgcolor="#8BA5C5">
    <TR> 
      <TD height="215" valign="top"> <h4>MySQL PHP Backup :: Backup</h4>
        ...
        ?>   
        <br>  
        These files are an unzipped backup of your database and must have the <em>same 
