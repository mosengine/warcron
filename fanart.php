...
<center>	<table cellspacing = "0" cellpadding = "0" border = "0">
	...
	<tr>
		...
		<td width = "1024" height="768" align=center valign=middle>
                ...
                $scandir = array_diff( scandir('media/fanart/'), array('..', '.'));
                ...
                echo '<a href="media/fanart/'.$img.'.jpg" target="_blank"><img style="background: 
                    url(media/fanart/'.$img.'.jpg) no-repeat 50% 50%;" src = "new-hp/images/pixel.gif" border = "0" width = "1024" height="768">';    
