...
<?php
	...
	while ($rowx = mysql_fetch_array($qquery)) {
		if (check_port_status($rowx['rsdbhost'], $rowx['rsdbport'], 0.3)) {
			$i++;
			$strmenu .= '	Menu1_'.$i.'=new Array(bulletImg+"'.$rowx['name'].'"+underLine,"?n=workshop.pvprankings&r='.$rowx['id'].'",menuBg,2,15,150,"","","","","","",-1,-1,-1,"","");
						Menu1_'.$i.'_1=new Array(bulletImg+"Alliance"+underLine,"?n=workshop.pvprankings&r='.$rowx['id'].'&f=alliance",menuBg,0,15,65,"","","","","","",-1,-1,-1,"","");
						Menu1_'.$i.'_2=new Array(bulletImg+"Horde"+underLine,"?n=workshop.pvprankings&r='.$rowx['id'].'&f=horde",menuBg,0,15,65,"","","","","","",-1,-1,-1,"","");';
		}
	}
