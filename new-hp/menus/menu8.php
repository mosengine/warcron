...
<body>
	...
	var UserLevel='<?php echo $_REQUEST['level']; ?>';
	...
	var TargetLoc="menuSupport";				// span id for relative positioning
...
// For rollover images ItemText or background image format is:  "rollover?"+BaseHref+"Image1.jpg?"+BaseHref+"Image2.jpg" 
	...
	Menu1=new Array(bulletImg+"Staff Personel"+underLine,"?n=support.staff",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
	<?php
		...
		while ($rowx = mysql_fetch_array($qquery)) {
			if (check_port_status($rowx['rsdbhost'], $rowx['rsdbport'], 0.3)) {
				$i++;
				$strmenu .= 'Menu2_'.$i.'=new Array(bulletImg+"'.$rowx['name'].'"+underLine,"?n=support.ingame&r='.$rowx['id'].'",menuBg,2,15,150,"","","","","","",-1,-1,-1,"","");
				';
				$strmenu .= 'Menu2_'.$i.'_1=new Array(bulletImg+"Commands"+underLine,"?n=support.ingame&r='.$rowx['id'].'&t=commands",menuBg,0,15,85,"","","","","","",-1,-1,-1,"","");
				';
				$strmenu .= 'Menu2_'.$i.'_2=new Array(bulletImg+"Tickets"+underLine,"?n=support.ingame&r='.$rowx['id'].'&t=tickets",menuBg,0,15,85,"","","","","","",-1,-1,-1,"","");
				';
			}
		}
	?>
	Menu2=new Array(bulletImg+"In-Game Support"+underLine,"?n=support.ingame",menuBg,<?php echo $i; ?>,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
	<?php echo $strmenu; ?>
	Menu3=new Array(bulletImg+"Donations"+underLine,"?n=support.donations",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
	Menu4=new Array(bulletImg+"Rules"+underLine,"?n=support.rules",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
if (UserLevel>0) {
	Menu5=new Array(bulletImg+"Site Administration"+underLine,"?n=admin",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
}
	</script>
