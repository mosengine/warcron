// awb512-119-u
	...
	var Arrws=["/shared/wow-com/images/subnav/tri.gif",14,15,"http://www.worldofwarcraft.com/shared/wow-com/images/subnav/tri.gif",14,15,"http://www.worldofwarcraft.com/shared/wow-com/images/subnav/tri.gif",14,15,"http://www.worldofwarcraft.com/shared/wow-com/images/subnav/tri.gif",14,15];
...
if (IsLogged!='') {	
	Menu1=new Array(bulletImg+"Manage Account"+underLine,"?n=account.manage",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"",""); 
	if (PMEnabled==true) {
		Menu2=new Array(bulletImg+"Private Messages ("+PMTotal+")"+underLine,"?n=forums.pm",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"",""); 
		Menu3=new Array(bulletImg+"Log Out ["+IsLogged+"]"+underLine,"?n=account.logout",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"",""); 
		Menu4=new Array(bulletImg+"Realm Status"+underLine,"?n=account.realmstatus",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
	} else {
		Menu2=new Array(bulletImg+"Log Out ["+IsLogged+"]"+underLine,"?n=acount.logout",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"",""); 
		Menu3=new Array(bulletImg+"Realm Status"+underLine,"?n=account.realmstatus",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
	}
	
} else {
	Menu1=new Array(bulletImg+"Create Account"+underLine,"?n=account.create",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
	Menu2=new Array(bulletImg+"Log In"+underLine,"?n=account.login",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"",""); 
	Menu3=new Array(bulletImg+"Retrieve Password"+underLine,"?n=account.retrievepassword",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
	Menu4=new Array(bulletImg+"Realm Status"+underLine,"?n=account.realmstatus",menuBg,0,15,140,"transparent","","","","transparent","",-1,-1,-1,"","");
}