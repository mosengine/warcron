						...
						<li>
							...
							<xsl:choose>
								...
								<xsl:when test="@type = 'report'">
									<a id="reportLink" class="staticTip" href="{@url}" onmouseover="setTipText('{$loc/strs/common/str[@id='report-error']}')" onmouseout="hideTip();" target="_blank"><xsl:value-of select="@name"/></a>
									<script type="text/javascript">
