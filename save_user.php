...
if (isset($_POST['skin'])) { $skin = $_POST['skin']; if ($skin == '') { unset($skin);} } //заносим введенный пользователем e-mail, если он пустой, то уничтожаем переменную
