...
function spellTextObject() {
	...
	this.penetration = new spellPenetrationTextObject();
...
replaceStringSpell += '<li onMouseover="javascript: showTip(\&quot;'+ theText.spell.penetration.mouseover +'\&quot;);" onMouseOut="javascript: hideTip();"><span>'+  theText.spell.penetration.display +'</span><i '+ theText.spell.penetration.effectiveColor +'>'+ theText.spell.penetration.value +'</i></li>';
...
if (theClassId == 1 || theClassId == 4 || theClassId == 2)
