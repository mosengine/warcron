...
if(isset($_GET["searchQuery"]))
{
	...
	// urlencode for IE compatibility
	$o->setobvar("AFTER_BODYTAG", "onLoad=\"showResult('?searchQuery=".urlencode($currentSearchString)."','source/ajax/ajax-search-getresults.php')\"");
}
else
	$currentSearchString = "";
?>
